...
describe('lists reducer', () => {
    ...
    describe('DOWNLOAD PDF ACTIONS', () => {
        it('should handle PDF_DOWNLOAD_REQUEST', () => {
            expect(lists({}, {
        ...
        it('should handle PDF_DOWNLOAD_SUCCESS', () => {
            expect(lists({}, {
                ...
                notification: {
                    message: 'Successfully downloaded pdf for list - Shopping List.',
                    level: 'success',
                    title: 'Success'
                },
                isFetching: false,
        ...
        it('should handle PDF_DOWNLOAD_ERROR', () => {
            expect(lists({}, {
