...
## Build and Zip up client and server for deployment

```sh
./scripts/build_and_upload_client.sh --profile <aws-profile> --app-name <app-name> --deploy-bucket <bucket-app-name> --version <version>
```